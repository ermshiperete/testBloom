namespace Bloom
{
	partial class RegisterDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.l10NSharpExtender1.SetLocalizingId(this.label8, "RegisterDialog.HowAreYouUsing");
			...
			this.label8.Text = "How are you using Bloom?";
			//
			// _howAreYouUsing
			//
			...
			this.l10NSharpExtender1.SetLocalizingId(this._howAreYouUsing, "RegisterDialog.textBox5");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.label1, "RegisterDialog.WeAreHappy");
			this.label1.Location = new System.Drawing.Point(3, 0);
			this.label1.MaximumSize = new System.Drawing.Size(400, 0);
			this.label1.Name = "label1";
			this.label1.Size = new System.Drawing.Size(338, 21);
			this.label1.TabIndex = 1;
			this.label1.Text = "We\'re happy that you are finding Bloom useful!";
			//
			// label4
			//
			...
			this.l10NSharpExtender1.SetLocalizingId(this.label4, "RegisterDialog.JokeAboutWillBeHappy");
			...
			this.label4.Size = new System.Drawing.Size(378, 34);
			this.label4.TabIndex = 10;
			this.label4.Text = "(That is, we will be happy as soon as we hear how you\'re using Bloom.)";
			//
			// tableLayoutPanel2
			//
